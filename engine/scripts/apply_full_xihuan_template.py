...
export const EtymologyTemplate: React.FC<EtymologyConfig> = ({
  ...
  const anim = animationTimestamps || {
    screen1: {
      ...
      clothMention: { startFrame: 200, endFrame: 250 },
      wallMention: { startFrame: 270, endFrame: 330 },
      altarMention: { startFrame: 270, endFrame: 330 },
      muscleMention: { startFrame: 270, endFrame: 330 },
    },
    screen2: {
      startFrame: screen1EndFrame,
      endFrame: screen2EndFrame,
      topBang: { startFrame: screen1EndFrame, endFrame: 660 },
      bottomJin: { startFrame: 660, endFrame: 900 },
      wholeBang: { startFrame: 900, endFrame: screen2EndFrame },
    },
    screen3: {
      startFrame: screen2EndFrame,
      endFrame: screen3EndFrame,
      wholeZhuIntro: { startFrame: screen2EndFrame, endFrame: 1070 },
      leftQie: { startFrame: 1070, endFrame: 1200 },
      rightLi: { startFrame: 1200, endFrame: 1340 },
      wholeZhuOutro: { startFrame: 1340, endFrame: screen3EndFrame },
    },
    screen4: {
      startFrame: screen3EndFrame,
      endFrame: lessonDurationInFrames,
      bangHighlightEndFrame: 1550,
    },
  };
            ...
            {isScreen1 && (
              <div style={{
                ...
                <h2 style={{ fontFamily: FONTS.display, fontSize: 56, color: '#FFFFFF', margin: 0, lineHeight: 1.2 }}>
                  ...
                  {isXihuan ? 'Combine War Drums & Cheering?' : isKaishi ? 'Contain a Gate & New Life?' : isJieshao ? 'Contain a Person & Silk?' : isWangji ? 'Contain Disappearing & Words?' : isAiqing ? 'Contain a Friend & Heart?' : isPengyou ? 'Feature 2 Moons & 2 Hands?' : 'Contain Cloth & Muscle?'}
                </h2>
              </div>
            )}
            {isScreen2 && (
...
print("Applied updated EtymologyTemplate.tsx with complete 喜欢 support!")
