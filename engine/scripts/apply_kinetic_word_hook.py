...
export const EtymologyTemplate: React.FC<EtymologyConfig> = ({
  ...
  const cameraZoomScale = isHeroWordPhase
    ...
    : interpolate(heroRevealSpring, [0, 1], [1.35, 1.0]) * continuousPush;
  ...
  // Visual pulse / fracture tension during "I like you" (frames 95-150)
...
print("✅ Applied dynamic word-by-word kinetic hook with camera crash zoom!")
